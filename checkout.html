...
<body class="cart">
	...
	<section class="container">
		<div class="pageHeader" style="background-image: url(images/content/cart.jpg);">
				...
				<div class="mcell">
					<h3>Ship to a different address? 
						<label class="checkboxBox" for="checkboxId">
							<input id="checkboxId" class="" type="checkbox" name="" value="">
							<span></span>
						</label>
					</h3>
					<p class="form-row form-row-first">
					...
					<p class="form-row form-row-wide">
						<label class="" for="billing_address_1_2">Address</label>
					...
					<p class="form-row form-row-wide">
						...
						<input id="order_notes" class="input-text " type="text" value="" placeholder="" name="">
					</p>
				</div>
				<div class="scell">
					<h3>Your Order</h3>
					<div class="cartItemWrap">
						<div class="cartItem">
							<a href="#" class="cartItemImg">
								<img src="images/content/cartImg.jpg" alt="">
							</a>
							<h4><a href="#">Giam Sol Premum-Grip Yoga Mat (8mm)</a></h4>
							<p>$28</p>
							<p>Quantity: 1</p>
						</div>
					</div>
					<div class="cartTotalsWrap clear">
						<p>Cart Subtotal <span>$28</span></p>
						<p>Shipping <span>Free Shipping</span></p>
						<p><strong>Order Total <span>$28</span></strong></p>
						<ul class="payment_methods methods">
							...
							<li class="payment_method_paypal">
								<input id="payment_method_paypal" class="input-radio" type="radio" value="paypal" name="payment_method">
								<label for="payment_method_paypal">
								PayPal
								</label>
							</li>
						</ul>
						<input class="checkoutBtn" type="submit" value="Place order">
					</div>
				</div>
			</div>
				...
				<div class="miniCartItemWrap">
					<div class="miniCartItem">
						<a href="" class="miniCartItemImg">
							<img src="images/content/miniCartImg.jpg" alt="">
						</a>
						<h3>
					...
					<div class="miniCartItem">
						<a href="" class="miniCartItemImg">
							<img src="images/content/miniCartImg2.jpg" alt="">
						</a>
						<h3>
							<a href="#">Giam Sol Premum-Grip Yoga Mat (8mm)</a>
						</h3>
