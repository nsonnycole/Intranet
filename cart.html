						...
						<tr>
							...
							<td>
								<div class="quantityBox">
									<input class="" type="number" name="" value="1" placeholder="">
								</div>
							</td>
							<td>$28</td>
							<td><a href="" class="removeCartItem"></a></td>
						</tr>
						<tr>
							<td>
								<div class="cartProduct">
									<a href="#" class="cartProductImg">
										<img src="images/content/cartImg2.jpg" alt="">
									</a>
									<h4><a href="#">Giam Sol Premum-Grip Yoga Mat (18mm)</a></h4>
								</div>
							</td>
							<td>$28</td>
							<td>
				...
				<div class="cartTotals">
					<div class="coupon">
						<form>
							...
							<input class="applyCoupon" type="submit" value="Submit">
						</form>
					</div>
					<div class="cartTotalsWrap clear">
						<h2>Cart totals</h2>
						<p>Subtotal <span>$56</span></p>
						<p>Shipping <span>Free Shipping</span></p>
						<p>Total <span>$56</span></p>
						<input class="updateCartBtn" type="button" value="update cart">
