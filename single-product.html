...
<html lang="uk">
	<head>
		<title>Asana - Single product</title>
...
<body class="single-product">
	...
	<section class="container">
		<div class="pageHeader" style="background-image: url(images/content/catalog.jpg);">
		...
		<div class="contentWrap">
					...
					<div class="productGallery clear">
						<div class="galleryThumb">
							<a href="#imgId1" class="galleryThumbItem active">
								<img src="images/content/galleryThumb.jpg" alt="">
							</a>
							<a href="#imgId2" class="galleryThumbItem">
								<img src="images/content/galleryThumb2.jpg" alt="">
							</a>
							<a href="#imgId3" class="galleryThumbItem">
								<img src="images/content/galleryThumb3.jpg" alt="">
							</a>
							<a href="#imgId4" class="galleryThumbItem">
								<img src="images/content/galleryThumb4.jpg" alt="">
							</a>
						</div>
						<div class="productGalleryWrap">
							<img class="current" id="imgId1" src="images/content/proImg.jpg" alt="">
							<img id="imgId2" src="images/content/proImg2.jpg" alt="">
							<img id="imgId3" src="images/content/proImg3.jpg" alt="">
							<img id="imgId4" src="images/content/proImg4.jpg" alt="">
						</div>
					</div>
					<div class="productDesc">
						<h1>Gaiam Sol Premium-Grip Yoga Mat 8mm</h1>
						<div class="price"><span>$</span>28</div>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sed do eiusmod tempor incididunt. Sed do eiusmod tempor incididunt.</p>
			...
			<div class="relatedProducts">
				<div class="blockTitle">Related products</div>
				<div class="shopItems">
